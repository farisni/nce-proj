...
{ text: "In the young there is a justification for this feeling.", translation: "青年人有这种感觉是情有可原的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Young men who have reason to fear that they will be killed in battle may justifiably feel bitter in the thought that they have been cheated of the best things that life has to offer.", translation: "有理由害怕自己会死在战场上的年轻人，想到自己被剥夺了生活所能给予的最美好的东西时，感到痛苦，这是可以理解的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "But in an old man who has known human joys and sorrows, and has achieved whatever work it was in him to do, the fear of death is somewhat abject and ignoble.", translation: "可是老年人已经饱尝了人间的甘苦，一切能做的都做了，如果怕死，就有点儿可怜又可鄙。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The best way to overcome it -- so at least it seems to me -- is to make your interests gradually wider and more impersonal, until bit by bit the walls of the ego recede, and your life becomes increasingly merged in the universal life.", translation: "克服怕死的最好办法 -- 至少在我看来是这样 -- 就是逐渐使自己的兴趣更加广泛，逐渐摆脱个人狭小的圈子，直到自我的围墙一点一点地倒塌下来，自己的生活慢慢地和整个宇宙的生活融合在一起。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "One is the general atmosphere of secrecy in which it is carried out, the other the lack of freedom of the individual research worker.In so far as any inquiry is a secret one, it naturally limits all those engaged in carrying it out from effective contact with their fellow scientists either in other countries or in universities, or even, often enough, in other departments of the same firm.", translation: "任何一项研究都涉及到保密，那些从事科研的人员自然受到了限制。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "In so far as any inquiry is a secret one, it naturally limits [all those engaged in carrying it out] from effective [contact with their fellow scientists] either in other countries or in universities, or even, often enough, in other departments of the same firm.", translation: "他们不能和其他国家、其他大学、甚至往往不能与本公司的其他部门的同行们进行有效的接触。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The degree of secrecy naturally varies considerably.", translation: "保密程度自然差别很大。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Some of the bigger firms are engaged in researches which are of such general and fundamental nature that it is a positive advantage to them not to keep them secret.", translation: "某些大公司进行的研究属于一般和基础的研究，因此不保密对他们才有利。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Yet a great many processes depending on such research are sought for with complete secrecy until the stage at which patents can be taken out.", translation: "然而，依赖这种研究的很多工艺程序是在完全保密的情况下进行的，直到可以取得专利权的阶段为止。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Even more processes are never patented at all but kept as secret processes.", translation: "更多的工艺过程根本就不会取得专利权，而是作为秘方保存着。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This applies particularly to chemical industries, where chance discoveries play a much larger part than they do in physical and mechanical industries.", translation: "在这化学工业方面尤为突出。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Sometimes the secrecy goes to such an extent that the whole nature of the research cannot be mentioned.", translation: "同物理和机械工业相比，化学工业中偶然发现的机会要多得多。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L16: Article = {
  ...
  attribution: "ALEXIS CARREL（亚历克西斯·卡雷尔）《Man, the Unknown》",
    ...
    paragraphs: [
[
{ text: "In the organisation of industrial life the influence of the factory upon the physiological and mental state of the workers has been completely neglected.", translation: "在工业生活的组织中，工厂对工人的生理和精神状态的影响完全被忽视了。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Modern industry is based on the conception of the maximum production at lowest cost, in order that an individual or a group of individuals may earn as much money as possible.", translation: "现代工业的基本概念是：以最低成本获取最多产品，为的是让某个个人或某一部分人尽可能多地赚钱。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It has expanded without any idea of the true nature of the human beings who run the machines, and without giving any consideration to the effects produced on the individuals and on their descendants by the artificial mode of existence imposed by the factory.", translation: "现代工业发展起来了，却根本没想到操作机器的人的本质。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The great cities have been built with no regard for us.", translation: "工厂把一种人为的生存方式强加给工人，却不顾及这种生存方式给工人及其后代带来的影响。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The shape and dimensions of the skyscrapers depend entirely on the necessityn.", translation: "大城市的建设毫不关心我们。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The shape and dimensions of the skyscrapers depend entirely on the necessity of obtaining the maximum income per square foot of ground, and of offering to the tenants offices and apartments that please them.", translation: "摩天大楼完全是按这样的需要修建的：每平方英尺地皮取得最大收入和向租房人提供使他满意的办公室和住房。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This caused the construction of gigantic buildings where too large masses of human beings are crowded together.", translation: "这样就导致了许多摩天大厦拔地而起，大厦内众多的人挤地一起。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Civilised men like such a way of living.", translation: "文明人喜欢这样一种生活方式。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "While they enjoy the comfort and banal luxury of their dwelling, they do not realise that they are deprived of the necessities of life.", translation: "在享受自己住宅的舒适和庸俗的豪华时，却没有意识到被剥夺了生活所必需的东西。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The modern city consists of monstrous edifices and of dark, narrow streets full of petrol fumes and toxic gases, torn by the noise of the taxicabs, lorries and buses, and thronged ceaselessly by great crowds.", translation: "大得吓人的高楼和阴暗狭窄的街道组成了今日现代化的城市。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Obviously, it has not been planned for the good of its inhabitants.", translation: "街道上充斥着汽油味和有毒气体，出租汽车、卡车、公共汽车的噪音刺耳难忍，络绎不绝的人群挤来挤去。 显然，现代化的城市不是这居民的利益而规划的。", predicates: [], clauseIntroducers: [], notes: [] }
]
],
  },
...
{ text: "Surely because progress of a particular kind is actually taking place around us and is becoming more and more manifest.", translation: "无疑是因为有一种特殊的进步实际上正在我们周围发生，而且变得越来越明显。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Although mankind has undergone no general improvement in intelligence or morality, it has made extraordinary progress in the accumulation of knowledge.", translation: "虽然人类有智力和道德上没有得到普遍提高，但在知识积累方面却取得了巨大的进步。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Knowledge began to increase as soon as the thoughts of one individual could be communicated to another by means of speech.", translation: "人一旦能用语言同别人交流思想，知识的积累便开始了。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "With the invention of writing, a great advance was made, for knowledge could then be not only communicated but also stored.", translation: "随着书写的发明，又迈进了一大步，因为这样一来，知识不仅能交流，而且能储存了。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Libraries made education possible, and education in its turn added to libraries: the growth of knowledge followed a kind of compound interest law, which was greatly enhanced by the invention of printing.", translation: "藏书使教育成为可能，而教育反过来又丰富了藏书，因为知识的增长遵循着一种“滚雪球”的规律。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "All this was comparatively slow until, with the coming of science, the tempo was suddenly raised.", translation: "印刷术的发明又大大提高了知识增长的速度。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Then knowledge began to be accumulated according to a systematic plan.", translation: "所有这些发展都比较缓慢，而随着科学的到来，增长的速度才突然加快。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The trickle became a stream; the stream has now become a torrent.", translation: "于是，知识便开始有系统有计划地积累起来。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Moreover, as soon as new knowledge is acquired, it is now turned to practical account.", translation: "涓涓细流汇成小溪，小溪现已变成了奔腾的江河。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "What is called 'modern civilization' is not the result of a balanced development of all man's nature, but of accumulated knowledge applied to practical life.", translation: "而且，新知识一旦获得，便得到实际应用。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The problem now facing humanity is: What is going to be done with all this knowledge?", translation: "所谓“现代文明”并不是人的天性平衡发展的结果，而是积累起来的知识应用到实际生活中的结果。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "As is so often pointed out, knowledge is a two-edged weapon which can be used equally for good or evil.", translation: "现在人类面临的问题是：用这些知识去做什么？", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It is now being used indifferently for both.", translation: "正像人们常常指出的，知识是一把双刃刀，可以用于造福，也可以用来为害。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Could any spectacle, for instance, be more grimly whimsical than that of gunners using science to shatter men's bodies while, close at hand, surgeons use it to restore them?", translation: "人们现在正漫不经心地把知识用于这两个方面，例如：炮兵利用科学毁坏人的身体、而外科医生就在附近用科学抢救被炮兵毁坏的人体，还有什么情景比这更可怕、更怪诞的吗？", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "We have to ask ourselves very seriously what will happen if this twofold use of knowledge, with its ever-increasing power, continues.", translation: "我们不得不严肃地问问我们自己：随着日益增长的知识的力量，如果我们继续利用知识的这种双重性，将会发生什么样的情况呢？", predicates: [], clauseIntroducers: [], notes: [] }
]
],
  },
...
{ text: "This modern faith in medicines is proved by the fact that the annual drug bill of the Health Services is mounting to astronomical figures and shows no signs at present of ceasing to rise.", translation: "卫生部门的年度药费上升到了天文数字，并且目前尚无停止上升的迹象，这个事实证实了现代人对药物的依赖。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The majority of the patients attending the medical out-patients departments of our hospitals feel that they have not received adequate treatment unless they are able to carry home with them some tangible remedy in the shape of a bottle of medicine, a box of pills, or a small jar of ointment, and the doctor in charge of the department is only too ready to provide them with these requirements.", translation: "在医院门诊部看病的大多数人觉得，如果不能带回一些看得见、摸得着的药物，如一瓶药水，一盒药丸、一小瓶药膏回家的话，就没算得到了充分的治疗。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "There is no quicker method of disposing of patients than by giving them what they are asking for, and since most medical men in the Health Services are overworked and have little time for offering time-consuming and little-appreciated advice on such subjects as diet, right living, and the need for abandoning bad habits etc., the bottle, the box, and the jar are almost always granted them.", translation: "负责门诊的医生也非常乐意为前来看病的人提供他们想要得到的药物，病人要什么就给什么，没有比这样处理病人更快的方法了。因为卫生部门的大多数医生超负荷工作，所以没有多少时间提出一些既费时而又不受人欢迎的忠告，如注意饮食、生活有规律，需要克服坏习惯等等，结果就是把瓶药、盒药、罐药开给看病的人而完事大吉。", predicates: [], clauseIntroducers: [], notes: [] }
],
      [
      { text: "Nor is it only the ignorant and ill-educated person who has such faith in the bottle of medicine.", translation: "并不只是那些无知和没受过良好教育的人才迷信药瓶子。", predicates: [], clauseIntroducers: [], notes: [] },
      { text: "It is recounted of Thomas Carlyle that when he heard of the illness of his friend, Henry Taylor, he went off immediately to visit him, carrying with him in his pocket what remained of a bottle of medicine formerly prescribed for an indisposition of Mrs. Carlyle's.", translation: "据说托马斯·卡莱尔有过这么一件事：他听说朋友亨利·泰勒病了，就立刻跑去看他，衣袋里装上了他妻子不舒服时吃剩下的一瓶药。", predicates: [], clauseIntroducers: [], notes: [] }
      ],
      [
        { text: "Carlyle was entirely ignorant of what the bottle in his pocket contained, of the nature of the illness from which his friend was suffering, and of what had previously been wrong with his wife, but a medicine that had worked so well in one form of illness would surely be of equal benefit in another, and comforted by the thought of the help he was bringing to his friend, he hastened to Henry Taylor's house.", translation: "卡莱尔不知道药瓶子里装的是什么药，不知道他的朋友得的是什么病，也不知道妻子以前得的是什么病，只知道一种药对一种病有好处，肯定对另一种病也会有好处。想到能对朋友有所帮助，他感到很欣慰，于是急急忙忙来到了亨利·泰勒的家里，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "History does not relate whether his friend accepted his medical help, but in all probability he did.", translation: "他的朋友是否接受了他的药物治疗，历史没有记载，但很可能接受了。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "The open sea was deep and mysterious, and anyone who gave more than a passing thought to the bottom confines of the oceans probably assumed that the sea bed was flat.", translation: "无边无际的海洋深邃而又神秘，凡是稍稍想过大海海底的人大概都会认为海底是平坦的。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "Shortly after this the famous H. M. S. Challenger expedition established the study of the sea-floor as a subject worthy of the most qualified physicists and geologists.", translation: "此后不久，英国著名的\"挑战者\"号舰艇对海底的那次考察，把对海床的研究确立为一个值得一流物理学家和地质学家从事的研究课题，", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "A burst of activity associated with the laying of submarine cables soon confirmed the challenger's observation that many parts of the ocean were two to three miles deep, and the existence of underwater features of considerable magnitude.", translation: "铺设海底电缆的热潮很快证实了\"挑战者\"号的观察结果：海洋中很多地方可深达两三英里，水下特征差异极大。", predicates: [], clauseIntroducers: [], notes: [] }
],
[
        { text: "Today, enough soundings are available to enable a relief map of the Atlantic to be drawn and we know something of the great variety of the sea bed's topography.", translation: "现在已有足够的水深测量数据来绘制一张大西洋洋底地形图，而且我对海底地形的千变万化也有了一定的了解。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Since the sea covers the greater part of the earth's surface, it is quite reasonable to regard the sea floor as the basic form of the crust of the earth, with, superimposed upon it, the continents, together with the islands and other features of the oceans.", translation: "既然海洋覆盖着地球的大部分表面，因此完全有理由把海床看作地壳的基本模壳，上面附加着大陆以及岛屿和海洋的其他形态。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The continents form rugged tablelands which stand nearly three miles above the floor of the open ocean.", translation: "大陆是崎岖不平的高地，高出辽阔的海洋海底近三英里。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "From the shore line, out a distance which may be anywhere from a few miles to a few hundred miles, runs the gentle slope of the continental shelf, geologically part of the continents.", translation: "从海岸线向大海延伸几英里到几百英里的区域是大陆架慢坡，从地质学上来说，它是大陆的一部分。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The real dividing line between continents and oceans occurs at the foot of a steeper slope.", translation: "大陆和海洋的真正分界线是在陡破脚下。", predicates: [], clauseIntroducers: [], notes: [] }
      ],
[
        { text: "This continental slope usually starts at a place somewhere near the 100-fatheom mark and in the course of a few hundred miles reaches the true ocean floor at 2,500-3,500 fathoms.", translation: "大陆架慢坡一般是从差不多100英寻水深的地方开始的，一直延伸到几百英里远深达2,500至3,500的地方，那里才是真正的海底。", predicates: [], clauseIntroducers: [], notes: [] },
...
[
        { text: "Normal people tend to forget this process unless and until they are reminded of it.", translation: "衰老的过程，不经提起，正常人容易忘记；一经提醒，才会记起。", predicates: [], clauseIntroducers: [], notes: [] },
...
[
        ...
        { text: "Of these the former are the majority.", translation: "这两类人当中，第一类人是大多数，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "They have their compensations.", translation: "他们能够得到补偿。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The long hours in the office or the factory bring with them as their reward, not only the means of sustenance, but a keen appetite for pleasure even in its simplest and most modest forms.", translation: "在办公室或工厂里长时间工作给他们带来了酬劳，这不仅是谋生的手段，而且还带来了寻找乐趣的强烈欲望，哪怕是最简单的、最低等的乐趣。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "But Fortune's favoured children belong to the second class.", translation: "但是，命运之神的宠儿是第二类人，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Their life is a natural harmony.", translation: "他们的生活是一种自然的和谐，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "For them the working hours are never long enough.", translation: "对他们来说，工作时间总不会太长，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Each day is a holiday, and ordinary holidays, when they come, are grudged as enforced interruptions in an absorbing vocation.", translation: "每天都是假日，而通常的假期来到，他们却惋惜这假期强制打断了他们埋头从事的工作。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Yet to both classes, the need of an alternative outlook, of a change of atmosphere, of a diversion of effort, is essential.", translation: "然而对这两种人来说，都需要换一换脑子，改变一下气氛，转移一下注意力，这是不可缺少的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Indeed, it may well be that those whose work is their pleasure are those who most need the means of banishing it at intervals from their minds.", translation: "说实在的，把工作当作享受的那些人最需要每隔一段时间把工作从头脑中撇开。", predicates: [], clauseIntroducers: [], notes: [] }
      ]
],
  },
...
const articleNce4L9: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "Alfred the Great acted as his own spy, visiting Danish camps disguised as a minstrel.", translation: "阿尔弗雷德大帝曾亲自充当间谍。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "In those days wandering minstrels were welcome everywhere.", translation: "他扮作吟游歌手到丹麦军队的营地里侦察。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "They were not fighting men, and their harp was their passport.", translation: "当时，浪迹天涯的吟游歌手到处受欢迎，他们不是作战人员，竖琴就是他们的通行证。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "'We've got more garages with smart people,' Mead observes.", translation: "“我们有更多的汽车间，那里有许多聪明人，”米德说。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L12: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "When anyone opens a current account at a bank, he is lending the bank money, repayment of which he may demand at any time, either in cash or by drawing a cheque in favour of another person.", translation: "任何人在银行开一个活期账户，就等于把钱借给了银行。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Primarily, the banker-customer relationship is that of debtor and creditor -- who is which depending on whether the customer's account is in credit or is overdrawn.", translation: "这笔钱他可以随时提取，提取的方式可以是取现金，也可以是开一张以他人为收款人的支票。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "But, in addition to that basically simple concept, the bank and its customer owe a large number of obligations to one another.", translation: "银行与储户的关系主要是债务人和债权人的关系。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Many of these obligations can give rise to problems and complications but a bank customer, unlike, say, a buyer of goods, cannot complain that the law is loaded against him.", translation: "究竟谁是债务人谁是债权人，要看储户是有结余还是透支。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The bank must obey its customer's instructions, and not those of anyone else.", translation: "除了这一基本的简单的概念外，银行和储户彼此还需承担大量义务。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "When, for example, a customer first opens an account, he instructs the bank to debit his account only in respect of cheques drawn by himself.", translation: "其中许多义务往往引起问题和纠纷。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "He gives the bank specimens of his signature, and there is a very firm rule that the bank has no right or authority to pay out a customer's money on a cheque on which its customer's signature has been forged.", translation: "但是储户不能像货物的买主那样来抱怨法律对自己不利。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It makes no difference that the forgery may have been a very skillful one: the bank must recognize its customer's signature.", translation: "银行必须遵照储户的嘱托办事，不能听从其他人的指令。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "For this reason there is no risk to the customer in the practice, adopted by banks, of printing the customer's name on his cheques.", translation: "比如，储户首次在银行开户时，嘱咐银行他的存款只能凭本世人签字的支票来提取。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "If this facilitates forgery, it is the bank which will lose, not the customer.", translation: "他把自己签名的样本交给银行，对此有一条非常严格的规定：银行没有任何权利或理由把储户的钱让伪造储户的支票取走。 即使伪造得很巧妙，也不能付款，因为银行有责任辨认出其储户的签名。 因此，某些银行已采用把储户印在支票上的作法。 这种做法对储户毫无风险。 如果因这种作法出现了伪造的话，受损失的将不是储户，而是银行。", predicates: [], clauseIntroducers: [], notes: [] }
]
],
  },
  vocabulary: [
...
const articleNce4L17: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "In the early days of the settlement of Australia,enterprising settlers unwisely introduced the European rabbit.", translation: "在澳大利亚移民初期，一些有创业精神的移民不明智地把欧洲兔子引进了澳大利亚。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This rabbit had no natural enemies in the Antipodes, so that it multiplied with that promiscuous abandon characteristic of rabbits.", translation: "这种兔子在澳大利亚及新西兰没有天敌，因此便以兔子所特有的杂乱交配迅猛繁殖起来。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It overran a whole continent.", translation: "整个澳洲兔子成灾。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It caused devastation by burrowing and by devouring the herbage which might have maintained millions of sheep and cattle.", translation: "它们在地下打洞，吃掉本可以饲养数百万头牛羊的牧草，给澳洲大陆造成了毁灭性的破坏。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Scientists discovered that this particular variety of rabbit (and apparently no other animal) was susceptible to a fatal virus disease, myxomatosis.", translation: "科学家们发现，这种特殊品种的兔子（显然不包括别的动物）易患一种叫“多发性粘液瘤”的致命毒性疾病。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "By infecting animals and letting them loose in the burrows, local epidemics of this disease could be created.", translation: "通过让染上此病的动物在洞内乱跑，就可以使这种疾病在一个地区蔓延起来。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Later it was found that there was a type of mosquito which acted as the carrier of this disease and passed it on to the rabbits.", translation: "后来又发现，有一种蚊子是传播这种疾病的媒介，能把此病传染给兔子。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L20: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "How it came about that snakes manufactured poison is a mystery.", translation: "蛇是怎样产生毒液的，这是一个谜。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Over the periods their saliva, a mild, digestive juice like our own, was converted into a poison that defies analysis even today.", translation: "蛇的唾液本来和我们人的消化液一样柔和，但经过漫长的时间，演变成了今天仍无法分析清楚的毒液。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "It was not forced upon them by the survival competition; they could have caught and lived on prey without using poison, just as the thousands of non-poisonous snakes still do.", translation: "毒液不是生存竞争强加给它们的，它们也可以不用毒液捕捉动物而生存，就像今天成千上万的无毒蛇那样。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L25: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "Many people in industry and the Services, who have practical experience of noise, regard any investigation of this question as a waste of time; they are not prepared even to admit the possibility that noise affects people.", translation: "在工业部门工作和在军队中服役的许多人对噪声音有切身的体会，他们认为对这个问题进行调查中浪费时间，甚至不愿承认噪音可能对人有影响。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "On the other hand, those who dislike noise will sometimes use most inadequate evidence to support their pleas for a quieter society.", translation: "另一方面，那些讨厌噪音的人有时会用不充分的证据来支持他们希望有一个较为安静的社会环境的要求。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This is a pity, because noise abatement really is a good cause. and it is likely to be discredited if it gets to be associated with bad science.", translation: "要求减少噪音是件好事，但是如果与拙劣的科学掺杂在一起的话，就不会被人们所信任，这是很遗憾的。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L26: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "It is animals and plants which lived in or near water whose remains are most likely to be preserved, for one of the necessary conditions of preservation is quick burial, and it is only in the seas and rivers, and sometimes lakes, where mud and silt have been continuously deposited, that bodies and the like can be rapidly covered over and preserved.", translation: "只有生活在水中或水边的动植物尸体最有可能被保存下来，因为保存的必要条件之一是迅速掩埋，所以只有在泥沙不停淤积的海洋和江河里，有时在湖泊里，尸体之类的东西才能被迅速地覆盖而保存下来。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "But even in the most favourable circumstances only a small fraction of the creatures that die are preserved in this way before decay sets in or, even more likely, before scavengers eat them.", translation: "即使是在最有利的环境中，死去的生物中也只有一小部分能在开始腐烂前，或更可能在被食腐动物吃掉之前，被这样保存下来。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L27: Article = {
  ...
  original: {
        paragraphs: [
[
{ text: "From the seventeenth-century empire of Sweden, the story of a galleon that sank at the start of her maiden voyage in 1628 must be one of the strangest tales of the sea.", translation: "1628年，一艘大帆船在处女航时就沉没了，这个从7世纪瑞典帝国流传至今的故事无疑是航海史上最离奇的事件之一。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "For nearly three and a half centuries she lay at the bottom of Stockholm harbour until her discovery in 1956.", translation: "这艘大船在斯德哥尔摩港口的海底躺了将近3个半世纪之后，直到1956年才被发现。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This was the Vasa, royal flagship of the great imperial fleet.", translation: "这就是“瓦萨”号，帝国大舰队的皇家旗舰。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "King Gustavus Adolphus, 'The Northern Hurricane', then at the height of his military success in the Thirty Years' War, had dictated her measurements and armament.", translation: "当时号称“北方飓风”的国王古斯夫斯.阿道尔弗正处在“三十年战争”的军事鼎盛阶段，他亲自规定了这艘船的规模和武器配备。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Triple gun-decks mounted sixty-four bronze cannon.", translation: "3层的火炮甲板上装着64门青铜加农炮，目的就是要在不断增长的瑞典势力中起主导作用。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "She was intended to play a leading role in the growing might of Sweden.", translation: "1628年8月10日，“瓦萨”号准备首航时，斯德哥尔摩一片欢腾。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "As she was prepared for her maiden voyage on August 10th, 1628, Stockholm was in a ferment.", translation: "人们从斯开波斯布朗和周围的岛屿前来观看这艘美丽的战船扬帆起航，乘风前进。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "From the Skeppsbron and surrounding islands the people watched this thing of beauty begin to spread her sails and catch the wind.", translation: "瑞典人辛辛苦苦干了3年才建成这件水上艺术品，它比以往任何船只雕刻得都更加精美，装饰得都更加华丽。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "They had laboured for three years to produce this floating work of art; she was more richly carved and ornamented than any previous ship.", translation: "高耸的船楼上雕刻了令人眼花缭乱的神仙、妖魔、骑士、国王、武士、美人鱼和小天使，还有用红色、金黄色、蓝色绘制的光彩夺目的兽形图案，象征着勇敢、力量和残暴，以激起当时崇尚迷信的水手们的想像。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The high stern castle was a riot of carved gods, demons, knights, kings, warriors, mermaids, cherubs; and zoomorphic animal shapes ablaze with red and gold and blue, symbols of courage, power, and cruelty, were portrayed to stir the imaginations of the superstitious sailors of the day.", translation: "这时，停泊在港口的其他战船向“瓦萨”号鸣炮致礼，“瓦萨”号也鸣炮回礼。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Then the cannons of the anchored warships thundered a salute to which the Vasa fired in reply.", translation: "当“瓦萨”号从弥漫的礼炮烟云中出现时，船头下浪花四溅，舰旗迎风招展，三角旗随风飘动，微风鼓起风帆，金碧辉煌的船楼闪耀着灿烂的色彩。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "As she emerged from her drifting cloud of gun smoke with the water churned to foam beneath her bow, her flags flying, pennants waving, sails fillng in the breeze, and the red and gold of her superstructure ablaze with colour, she presented a more majestic spectacle than Stockholmers had ever seen before.", translation: "“瓦萨”号展现的壮观景象是斯德哥尔摩人从未见过的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "All gun-ports were open and the muzzles peeped wickedly from them.", translation: "船上的炮眼开着，炮口虎视眈眈地向外窥视着。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "As the wind freshened there came a sudden squall and the ship made a strange movement, listing to port.", translation: "当风力增强时，突然刮来一阵大风，“瓦萨”号奇怪地摇晃了一下，便向左舷倾斜。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The Ordnance Officer ordered all the port cannon to be heaved to starboard to counteract the list, but the steepening angle of the decks increased.", translation: "炮长命令把左舷上所有大炮搬到右舷上来以抵消船的倾斜，但甲板的倾斜度仍在增加。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Then the sound of rumbling thunder reached the watchers on the shore, as cargo, ballast, ammunition and 400 people went sliding and crashing down to the port side of the steeply listing ship.", translation: "当物品、压舱物、弹药和400个人轰地一声滑向陡斜的左舷时，岸上的观众听到了雷鸣般的轰响。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "The lower gun-ports were now below water and the inrush sealed the ship's fate.", translation: "下层炮眼已淹没在水里，涌进船舱的水给“瓦萨”号带来了难以逃脱的厄运。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "In that first glorious hour, the mighty Vasa, which was intended to rule the Baltic, sank with all flags flying-in the harbour of her birth.", translation: "就这样，想要统治波罗的海的大型战舰“瓦萨”号，在它壮丽的起航时刻，带着全身飘扬的彩旗，沉没在了它诞生的港口。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L29: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "Many strange new means of transport have been developed in our century, the strangest of them being perhaps the hovercraft.", translation: "本世纪已研制出许多新奇的交通工具，其中最新奇的要数气垫船了。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "It was the idea of supporting a craft on a 'pad', or cushion, of low-pressure air, ringed with a curtain of higher pressure air.", translation: "他的设想是：用一个低压空气或软垫来支撑船体，软垫周围用高压空气环绕。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Ever since, people have had difficulty in deciding whether the craft should be ranged among ships, planes, or land vehicles -- for it is something in between a boat and an aircraft.", translation: "自那以后，人们很难决定是否应该将这种运载工具列为轮船、飞机，或是陆上交通工具，因为它是介于船和飞机之间。", predicates: [], clauseIntroducers: [], notes: [] },
...
{ text: "They have a character, perhaps two;", translation: "他们心中只在一个或两个角色。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "they are in that condition of eager discomfort which passes for inspiration;", translation: "他们处于急切不安的状态，而被当作是灵感。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "all admit radical changes of destination once the journey has begun;", translation: "他们无不承认，一旦“旅程”开始，“目的地”常有急剧的变化。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "one, to my certain knowledge, spent nine months on a novel about Kashmir, then reset the whole thing in the Scottish Highlands.", translation: "据我所知，有位作家花了9个月的时间写了一部关于克什米尔的小说，后来却把整个故事背景换成了苏格兰高地。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "I never heard of anyone making a 'skeleton', as we were taught at school.", translation: "我从未听说过任何一位作家像我们在学校那样，动笔前先列什么提纲。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "In the breaking and remaking, in the timing, interweaving, beginning afresh, the writer comes to discern things in his material which were not consciously in his mind when he began.", translation: "作家在剪裁修改、构思时间、穿插情节、以至从头重写的过程中，会领悟到素材中很多东西是他刚动笔时所未意识到的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "This organic process, often leading to moments of extraordinary self-discovery, is of an indescribable fascination.", translation: "这种有机的加工过程往往达到不寻常自我发现的境界，具有难以言表的构思魅力。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "A blurred image appears;", translation: "一个朦胧的形象出现在作家的脑海里，他左添一笔，右添一笔，形象反而消逝了；", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "he adds a brushstroke and another, and it is gone;", translation: "可是，好像还有什么东西存在着，不把它捕捉到，作家是不会罢休的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "but something was there, and he will not rest till he has captured it.", translation: "有时，一个作家一本书写完了，但兴奋仍不消散。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Sometimes the yeast within a writer outlives a book he has written.", translation: "我听说一些作家，除了自己的书外，别的书一概不读，犹如希腊神话中那位漂亮的少年，站在镜前，不能辨认自身的真面目。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "I have heard of writers who read nothing but their own books;", translation: "由于这个原因，作家喋喋不休地谈论自己的书，挖掘其隐晦的含义，询问周围人的反应。作家如此行事当然被人误解。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "like adolescents they stand before the mirror, and still cannot fathom the exact outline of the vision before them.", translation: "他还不如给人讲一个犯罪案件或一个恋爱故事。顺便说一句，他也是个不可饶恕的令人厌烦的人。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "For the same reason, writers talk interminably about their own books, winkling out hidden meanings, super-imposing new ones, begging response from those around them.", translation: "这种企图消除自己和读者之间距离的作法，企图用不了解自己的人的观点来研究自己塑造的形象的作法，会导致作家的毁灭，因为他已经开始为取悦他人而写作了。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "Of course a writer doing this is misunderstood: he might as well try to explain a crime or a love affair.", translation: "一两年前，一位年轻的英国作家发表了中肯的看法。他说，初稿是才华，以后各稿是艺术。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "He is also, incidentally, an unforgivable bore.", translation: "也是由于这个原因，作家同任何艺术家一样，找不到可休息的场所，找不到伙伴和活动使自己得到安逸。", predicates: [], clauseIntroducers: [], notes: [] }
],
[
        { text: "This temptation to cover the distance between himself and the reader, to study his image in the sight of those who do not know him, can be his undoing: he has begun to write to please.", translation: "任何局外人的判断也比不上他内心的正确判断。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
...
{ text: "The wind then speaks the message of the sun to the sea and the sea transmits it on through waves -- an ancient, exquisite, powerful message.", translation: "然后，风把太阳的住处带给了大海，海洋用波浪的形式传递这个信息 -- 一个源过流长、高雅而有力的信息。", predicates: [], clauseIntroducers: [], notes: [] }
],
[
        { text: "These ocean waves are among the earth's most complicated natural phenomena.", translation: "这些海浪属于地球上最复杂的自然现象。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The basic features include a crest (the highest point of the wave), a trough (the lowest point), a height (the vertical distance from the trough to the crest), a wave length (the horizontal distance between two wave crests), and a period (which is the time it takes a wave crest to travel one wave length).", translation: "它们的基本特征包括浪峰（波浪的最高点）、波谷（最低点）、浪高（从波谷到浪峰的垂直距离）、波长（两个浪峰间的水平距离）和周期（海峰走过一个波长所需的时间）。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "Although an ocean wave gives the impression of a wall of water moving in your direction, in actuality waves move through the water leaving the water about where it was.", translation: "虽然，海浪给人的印象是一堵由水组成的墙向你压过来，而实际上，浪从水中移过，而水则留在原处。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "If the water was moving with the wave, the ocean and everything on it would be racing in to the shore with obviously catastrophic results.", translation: "如果水和浪一起移动的话，那么大海和海里所有的东西就会向岸边疾涌过来，带来明显的灾难性后果。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "An ocean wave passing through deep water causes a particle on the surface to move in a roughly circular orbit, drawing the particle first towards the advancing wave, then up into the wave, then forward with it and then -- as the wave leaves the particles behind -- back to its starting point again.", translation: "穿过深水的海浪使水面上的一个微粒按照一种近乎圆形的轨道移动，先把微粒拉向前移动的海浪，然后推上波浪，随着波浪移动，然后 -- 当波浪把微粒留在身后时 -- 又回到出发点。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "From both maturity to death, a wave is subject to the same laws as any other 'living' thing.", translation: "从成熟到消亡，波浪和其他任何“活动中”的东西一样，都受制于共同的法则。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "For a time it assumes a miraculous individuality that, in the end, is reabsorbed into the great ocean of life.", translation: "一度它获得非凡的个性，但最终又被重新融进生命的大洋。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "The undulating waves of the open sea are generated by three natural causes: wind, earth movements or tremors, and the gravitational pull of the moon and the sun.", translation: "公海上起伏的波浪是由3个自然因素构成的：风、地球的运动或震颤和月亮、太阳的引力。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Once waves have been generated, gravity is the force that drives them in a continual attempt to restore the ocean surface to a flat plain.", translation: "一旦波浪形成，地球引力是持续不断企图使海面复原为平面的力量。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
...
{ text: "The gentle method requires more patience in the early stages, but produces a cheerful, good-tempered elephant who will give many years of loyal service.", translation: "温柔法要求在最初阶段保持较大的耐心，但这种方法可以训练出性情愉快、脾气温顺，能忠实为人服务多年的大象。", predicates: [], clauseIntroducers: [], notes: [] }
],
[
        { text: "The first essential in elephant training is to assign to the animal a single mahout who will be entirely responsible for the job.", translation: "驯象中至关重要的是指派一名专门的驯象员，全面负责这项工作。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Elephants like to have one master just as dogs do, and are capable of a considerable degree of personal affection.", translation: "大象和狗一样，喜欢有一个专一的主人，而且会对主人产生相当深厚的私人感情。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "There are even stories of half-trained elephant calves who have refused to feed and pined to death when by some unavoidable circumstance they have been deprived of their own trainer.", translation: "甚至有这样的故事：训练了一半的小象，由于不可避免的情况与他们的主人分离后，竟拒绝吃食，消瘦至死。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Such extreme cases must probably be taken with a grain of salt, but they do underline the general principle that the relationship between elephant and mahout is the key to successful training.", translation: "这种极端的事例虽不可全信，但强调了一项基本原则，象和驯象员之间的关系是驯象成功与否的关健。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "The most economical age to capture an elephant for training is between 15 and 20 years, for it is then almost ready to undertake heavy work and can begin to earn its keep straight away.", translation: "捕捉15至20岁之间年龄的大象进行驯象最为经济。这个年龄的象差不多已能干重活，可以很快挣回饲养它的开支。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "But animals of this age do not easily become subservient to man, and a very firm hand must be employed in the early stages.", translation: "但这个年龄的象不易驯服，因此开始阶段需要有一位强有力的老手。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The captive elephant, still roped to a tree, plunges and screams every time a man approaches, and for several days will probably refuse all food through anger and fear.", translation: "捕来拴在树上的大象，每当有人走近它时，就会向前猛冲并发出尖叫，甚至一连几天都由于愤怒和恐惧而拒绝进食。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Sometimes a tame elephant is tethered nearby to give the wild one confidence, and in most cases the captive gradually quietens down and begins to accept its food.", translation: "有时，把一头已驯服的象拴在旁边能给野象以信心。在大多数情况下，刚缚来的象会慢慢静下来，接着开始吃食。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The next stage is to get the elephant to the training establishment, a ticklish business which is achieved with the aid of two tame elephants roped to the captive on either side.", translation: "下一步就是把象带到训练场所，这是一件棘手的事，需要在它两侧拴上两头驯服的大象才能完成。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "When several elephants are being trained at one time, it is customary for the new arrival to be placed between the stalls of two captives whose training is already well advanced.", translation: "几只象同时训练时，通常是把新到的安置在两头训练得很好的大象的象厩中间，", predicates: [], clauseIntroducers: [], notes: [] },
        ...
        { text: "When it is eating normally, its own training begins.", translation: "当它进食正常了，训练就开始。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The trainer stands in front of the elephant holding a long stick with a sharp metal point.", translation: "驯练员手持一根有锋利金属尖头的长棒，站在象前。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Two assistants, mounted on tame elephants, control the captive from either side, while others rub their hands over his skin to the accompaniment of a monotonous and soothing chant.", translation: "两位助手骑在驯服的象的背上，从两侧控制新捕的象，其他人唱着单调的歌声用手抚摸象的皮肤。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "This is supposed to induce pleasurable sensations in the elephant, and its effects are reinforced by the use of endearing epithets. such as 'ho! my son', or 'ho! my father', or 'my mother', according to the age and sex of the captive.", translation: "据说这是为了使象产生愉快的感觉，为了加强这种效果，人们还按象的年龄性别，给以亲切的外号，如“嗬！我的孩子”、“嗬！我的爸爸”、“嗬！我的妈妈”。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The elephant is not immediately susceptible to such blandishments, however, and usually lashes fiercely with its trunk in all directions.", translation: "然而大象不会立刻被这些讨好的话感动，而往往是用鼻子朝各个方向猛烈地甩动。", predicates: [], clauseIntroducers: [], notes: [] },
...
[
        ...
        { text: "A simple experiment will help us a little further.", translation: "再做一个简单的实验可以帮助我们进一步理解这个问题。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Tie a heavy weight at the end of a long piece of string.", translation: "把一个重物拴在一根长绳子的一端，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "With the hand held high in the air, hold the string so that the weight nearly touches the ground.", translation: "把手高高举在空中握住绳子，让重物几乎接触地面。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Now move the hand to and fro and around but not up and down.", translation: "然后把手前后左右以及旋转摆动，但不要上下摆动。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "It will be found that the weight moves but slightly or not at all.", translation: "结果会发现，重物是动了，但动得很小，甚至没动。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Imagine a pen attached to the weight in such a way that its point rests upon a piece of paper on the floor.", translation: "假定把一支笔拴在重物上，笔尖落在地板上的一张纸上，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Imagine an earthquake shock shaking the floor, the paper, you and your hand.", translation: "假定地震发生了，地板、纸、你和你的手都会动，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "In the midst of all this movement, the weight and the pen would be still.", translation: "重物和笔却不动。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "But as the paper moved from side to side under the pen point, its movement would be recorded in ink upon its surface.", translation: "由于纸在笔下来回运动，纸的表面就会用墨水记录下地板运动的情况。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "It was upon this principle that the first instruments were made, but the paper was wrapped round a drum which rotated slowly.", translation: "根据这一原理，制造出了最初的地震仪器，但是纸是卷在慢慢转动的圆筒上的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "As long as all was still, the pen drew a straight line, but while the drum was being shaken, the line that the pen was drawing wriggled from side to side.", translation: "只要一切都是静止的，笔就会划出一条直线；但是，圆筒受到震动，笔所画出的线就会左右摆动。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The apparatus thus described, however, records only the horizontal component of the wave movement, which is, in fact, much more complicated.", translation: "然而，这里所说的仪器记录下来的只是地震波运动中的水平部分，地震波的运动实际比这要复杂得多。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "If we could actually see the path described by a particle, such as a sand grain in the rock, it would be more like that of a bluebottle buzzing round the room;", translation: "假如我们真能看到诸如岩石中一个沙粒子的运动轨迹，那就像一只嗡嗡叫的绿头苍蝇在屋内飞行的轨迹，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "it would be up and down, to and fro and from side to side.", translation: "呈现出上上下下、来来回回、左左右右三种性质的运动。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Instruments have been devised and can be so placed that all three elements can be recorded in different graphs.", translation: "已经设计出了一些仪器，它按照一定的安放方式就可测绘出这三种运动的曲线图。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "When the instrument is situated at more than 700 miles from the earthquake centre, the graphic record shows three waves arriving one after the other at short intervals.", translation: "如果把这种仪器安装在距震源700多英里远的地方，曲线记录就能显示出前后相同的三种地震波。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The first records the arrival of longitudinal vibrations.", translation: "首先记录下的是纵向波的到达；", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The second marks the arrival of transverse vibrations which travel more slowly and arrive several minutes after the first.", translation: "然后记录下的是横向波的到达，横向波比纵向波传播得慢，在纵向波到达几分钟后能到达。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "These two have travelled through the earth.", translation: "这两种波都是穿过地球而来的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "It was from the study of these that so much was learnt about the interior of the earth.", translation: "正是从这两种波的研究中，我们可以了解到地球内部的许多情况。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "The third, or main wave, is the slowest and has travelled round the earth through the surface rocks.", translation: "第三种波，即主波，是最慢的，是围绕地球通过表面岩石传来的。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
],
  },
  vocabulary: [
...
{ text: "Mars is too dry and poor in oxygen, Venus far too hot, and so is Mercury, and the outer planets have temperatures near absolute zero and hydrogen-dominated atmospheres.", translation: "火星太干燥又缺氧，金星太热，水星也一样。除此之外，太阳系的其他行星的温度都接近绝对零度，并围绕着以氢气为主的大气层。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "But other suns, stars as the astronomers call them, are bound to have planets like our own, and as is the number of stars in the universe is so vast, this possibility becomes virtual certainty.", translation: "但是，其他的太阳，既天文学家所说的恒星，肯定会有像我们地球一样的行星。因为宇宙中恒星的数目极其庞大，所以存在着产生生命星球的这种可能性是肯定无疑的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "There are 100,000 million stars in our own Milky Way alone, and then there are 3,000 million other Milky Ways, or galaxies, in the universe.", translation: "仅我们的银河系就有1000亿颗星，况且在宇宙中还有30亿个天河，即银河系。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "So the number of stars that we know exist is now estimated at about 300 million million million.", translation: "因此，我们所知道的现有恒星数目估计约有30亿X1000亿颗。", predicates: [], clauseIntroducers: [], notes: [] }
],
[
        { text: "Although perhaps only 1% of the life that has started somewhere will develop into highly complex and intelligent patterns, so vast is the number of planets, that intelligent life is bound to be a natural part of the universe.", translation: "虽然在已经产生生命的某个地方，可能只有1%会发展成高度复杂有智力的生命形态，但是行星的数目是那么庞大，有智力的生命必然是宇宙的自然组成部分。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "If then we are so certain that other intelligent life exists in the universe, why have we had no visitors from outer space yet?", translation: "既然我们如此坚信宇宙中存在着其他有智力的生命，那么我们为什么还未见到外层空间来访的客人呢？", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "First of all, they may have come to this planet of ours thousands or millions of years ago, and found our then prevailing primitive state completely uninteresting to their own advanced knowledge.", translation: "首先，他们可能在几千年前或几百年前已来过我们地球，并且发现我们地球那时普遍存在着的原始状态同他们的先进的知识相比是索然无味的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Professor Ronald Bracewell, a leading American radio astronomer, argued in Nature that such a superior civilization, on a visit to our own solar system, may have left an automatic messenger behind to await the possible awakening of an advanced civilization.", translation: "美国一位重要的射电天文学家罗纳德.布雷斯韦尔教授在《自然》杂志上提出了这样的观点：假如有如此高级文明生命访问了我们的太阳系，很可能会在离开太阳系时留下自动化信号装置，等待先进文明的觉醒。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Such a messenger, receiving our radio and television signals, might well re-transmit them back to its home-planet, although what impression any other civilization would thus get from us is best left unsaid.", translation: "这种自动化信息装置，在接收到我们的无线电和电视信号后，完全有可能把这些信号发回到原来的行星。至于其他文明行星对我们地球会有什么印象，还是不说为好。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "But here we come up against the most difficult of all obstacles to contact with people on other planets -- the astronomical distances which separate us.", translation: "然而，在和外星人联系中我们遇到的最大困难是分隔我们的天文距离。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "As a reasonable guess, they might, on an average, be 100 light years away. (A light year is the distance which light travels at 186,000 miles per second in one year, namely 6 million million miles.) Radio waves also travel at the speed of light, and assuming such an automatic messenger picked up our first broadcasts of the 1920's, the message to its home planet is barely halfway there.", translation: "据合理推算，外星人离我们平均距离也有100光年之远（1光年是光以每秒186，000英里的速度在一年内走的距离即6万亿英里）。", predicates: [], clauseIntroducers: [], notes: [] },
...
[
        { text: "Fortunately, there is a 'uniquely rational way' for us to communicate with other intelligent beings, as Walter Sullivan has put it in his excellent book, We Are not Alone.", translation: "幸运的是，有一种我们可以和其他智力生命通迅联系的“唯一合理的方法”，正如活尔特.沙利方在其杰作《我们并不孤独》中阐述的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "This depends on the precise radio frequency of the 21-cm wavelength, or 1420 megacycles per second.", translation: "这种通迅联系要靠21厘米波段，即每秒1420兆周的精确无线电频率。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "It is the natural frequency of emission of the hydrogen atoms in space and was discovered by us in 1951;", translation: "这个频率是空间氢原子释放的自然频率，是在1951年被人类发现的。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "it must be known to any kind of radio astronomer in the universe.", translation: "这个频率是宇宙中任何射电天文学家都应该熟悉的。", predicates: [], clauseIntroducers: [], notes: [] },
      ],
[
        { text: "Once the existence of this wave-length had been discovered, it was not long before its use as the uniquely recognizable broadcasting frequency for interstellar communication was suggested.", translation: "一旦这种波长的实际存在被发现，提出把它作为星际间唯一可辨认的广播频率就为期不远了。", predicates: [], clauseIntroducers: [], notes: [] },
...
const articleNce4L45: Article = {
  ...
  original: {
    paragraphs: [
[
{ text: "In man's early days, competition with other creatures must have been critical.", translation: "在人类早期，人类与其他生物的竞争一定是必不可少的。", predicates: [], clauseIntroducers: [], notes: [] },
{ text: "But this phase of our development is now finished.", translation: "但这个发展阶段已经结束。", predicates: [], clauseIntroducers: [], notes: [] },
...
[
        { text: "Whether the remarkable growth of organized camping means the eventual death of the more independent kind is hard to say.", translation: "有组织的露营活动的明显发展是否意味着较独立的自我封闭式露营的最终消失，还很难说。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Municipalities naturally want to secure the campers' site fees and other custom.", translation: "市政当局当然希望获得露营者的场地费和其他光临的好处，", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "Police are wary of itinerants who cannot be traced to a recognized camp boundary or to four walls.", translation: "警察则对那些查不出有固定营地或住处的游荡者保持警惕。", predicates: [], clauseIntroducers: [], notes: [] },
        { text: "But most probably it will all depend upon campers themselves: how many heath fires they cause;", translation: "但最重要的或许是露营者自己，即他们引起了多少场野火，", predicates: [], clauseIntroducers: [], notes: [] },
